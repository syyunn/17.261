...
# filepath = './week1/Fenno - 1962 - The House Appropriations Committee as a Political System.pdf'
# filepath = './week1/Matthews - 1959 - Folkways of the US Senate.pdf'
...
# For specific section
# print_answer("Explain more detail about how integration affects the power of committee. In addition, is there any chance of across-party conflict inside the committee which affects the function of the committee? What kind of norms are exisiting to prevent such organizational goal?", [Documents[18]], show_locator=True, show_question=False)
# pass